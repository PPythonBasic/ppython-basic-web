...
const reactHomeWorkMarkDown = [reactHomeWork1, reactHomeWork2, reactHomeWork3, reactHomeWork4, reactHomeWork5, reactHomeWork6, reactHomeWork7, reactHomeWork8, reactHomeWork9];
